...
describe "HashWithIndifferentAccess" do
  ...
  describe "stringify_keys" do
    it "should return hash with indifferent access" do
      @symbols.with_indifferent_access.stringify_keys.should.is_a ActiveSupport::HashWithIndifferentAccess
    end
  ...
  describe "deep_stringify_keys" do
    it "should return hash with indifferent access" do
      @nested_symbols.with_indifferent_access.deep_stringify_keys.should.is_a ActiveSupport::HashWithIndifferentAccess
    end
  ...
  describe "stringify_keys!" do
    it "should return hash with indifferent access" do
      @symbols.with_indifferent_access.dup.stringify_keys!.should.is_a ActiveSupport::HashWithIndifferentAccess
    end
  ...
  describe "deep_stringify_keys!" do
    it "should return hash with indifferent access" do
      @nested_symbols.with_indifferent_access.dup.deep_stringify_keys!.should.is_a ActiveSupport::HashWithIndifferentAccess
    end
  ...
  describe "nesting" do
    it "should preserve hash subclasses in nested hashes" do
      ...
      foo["foo"].should.is_a ActiveSupport::HashWithIndifferentAccess
