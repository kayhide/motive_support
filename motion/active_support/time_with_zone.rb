# Rewrote these methods not using string eval
# year mon month day mday wday yday hour min sec usec nsec to_date
...
module ActiveSupport
  ...
  class TimeWithZone
    ...
    delegate :year, :mon, :month, :day, :mday, :wday, :yday, :hour, :min, :sec, :usec, :nsec, :to_date, to: :time
