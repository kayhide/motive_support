# Removed CountryTimezone.new!, which was alias of original .new.
# Aliasing .new does not work on RubyMotion.
# Acordingly, rewrote CountryTimezone#initialize.
 ...
 module TZInfo
  ...
  class CountryTimezone
    ...
    def initialize(identifier, latitude, longitude, description = nil) #:nodoc:
      ...
      when Array
        @latitude = nil
        @latitude_numerator, @latitude_denominator = latitude
      else
        fail ArgumentError, 'latitude must be Rational or Array'
      end
      ...
      when Array
        @latitude = nil
        @longitude_numerator, @longitude_denominator = longitude
      else
        fail ArgumentError, 'longitude must be Rational or Array'
      end
